...
threshold = mean_distance + 2.25 * std_distance
...
plt.scatter(data_reduced[far_away, 0], data_reduced[far_away, 1], color='red', marker='o', edgecolor='k', s=50, alpha=0.5, label='Far from centroid')
plt.title('KMeans Clustering Plot with Anomaly Points Marked')
